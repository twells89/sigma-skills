...
an intake manifest, and clones a best-practice fixture before discovery. A
...
before choosing an input-table architecture here.
...
| `reference/workflows/generate-apps.md` | **Generate a Sigma app.** Load first when the user asks to build a planning, approval, allocation, or exception app (and did not supply a target image). Classifies the type, asks structural questions, records an intake manifest, and clones a best-practice fixture before discovery. |
