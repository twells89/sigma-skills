...
skill is copied to `<project>/.sigma-skills/sigma-plugin-authoring/` (project install) or
`~/.sigma-skills/sigma-plugin-authoring/` (global install). Resolve every relative
